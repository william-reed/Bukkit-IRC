...
/**
 * Originally taken from Alexander Boyd from
 * http://me.opengroove.org/2009/10/single-file-irc-server.html and has since
 * been modified.
 * 
 * @author William Reed
 * 
				...
				synchronized (mutex) {
					...
					if (channel.topic != null)
						...
						con.sendGlobal("331 " + con.nick + " " + channel.name
								+ " :No topic is set");
					for (Connection channelMember : channel.channelMembers) {// 353,366
